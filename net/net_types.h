...
enum {
    ...
    /* OSQL offload requests (UUID-based) */
    ...
    NET_OSQL_SOCK_REQ = 156,
    NET_OSQL_SOCK_RPL = 157,
    NET_OSQL_SIGNAL = 158,
    NET_OSQL_RECOM_REQ = 159,
    NET_OSQL_RECOM_RPL = 160,
    NET_OSQL_SNAPISOL_REQ = 161,
    NET_OSQL_SNAPISOL_RPL = 162,
    NET_OSQL_SERIAL_REQ = 163,
    NET_OSQL_SERIAL_RPL = 164,
    NET_HBEAT_SQL = 165,
    NET_OSQL_POKE_UUID = 166, /* obsolete */
    NET_OSQL_MASTER_CHECK = 167,
    NET_OSQL_MASTER_CHECKED = 168,
    NET_OSQL_SOCK_REQ_COST = 169,
